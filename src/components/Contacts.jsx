...
const Contacts = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "d130de5e-2815-41a2-a96e-381bd3619092");
  ...
  return (
    ...
    <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>Ready to make a move ? Lets Yuild Your Future Together</p>
    ...
    <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
        ...
        <button className='bg-yellow-800 text-white py-2 px-12 mb-10 rounded '>{result ? result : "send message"}</button>
    </form>
    </motion.div>
  )
}
