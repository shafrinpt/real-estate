...
const Testimonials = () => {
  return (
    ...
    viewport={{once: true}}
    className='container mx-auto py-10 lg:px-32 w-full overflow-hidden' id='Tesitimonials'>
        ...
        <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>Real people, real homes, real happiness—hear their stories.</p>
